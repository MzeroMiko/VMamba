...
def get_args():
    ...
    # =======================================
    parser.add_argument("--pycmds", type=str, default="main_ema.py --cfg configs/swin/swin_tiny_patch4_window7_224.yaml --batch-size 64 --data-path /home/ma-user/modelarts/inputs/data_url_0 --output /home/ma-user/modelarts/outputs/train_url_0 --model_ema --opts MODEL.TYPE vssm MODEL.NAME vssmtiny ")
...
# --code_url Swin-Transformer-main
# --pack_url package
# --pycmds "main.py --cfg configs/swin/swin_tiny_patch4_window7_224.yaml --batch-size 64 --data-path /home/ma-user/modelarts/inputs/data_url_0/imagenet --output /home/ma-user/modelarts/outputs/train_url_0/ --opts DATA.NUM_WORKERS 0 MODEL.TYPE vmambaref MODEL.NAME vmambaref_tiny_patch4_window7_224"
$(date +%Y%m%d%H%M%S)
"""
