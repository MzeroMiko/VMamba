...
def main01():
    ...
    if True:
        ...
        tacv164 = partial(_model.VSSM, dims=96, depths=[2,4,6,2], ssm_d_state=1, ssm_dt_rank="auto", ssm_ratio=1.0, ssm_conv=5, forward_type="xv1a_act", mlp_ratio=4.0, downsample_version="v3", patchembed_version="v2", norm_layer="ln2d") # GFlops:  4.868279039999999 Params:  27574696 1529
        tacv165 = partial(_model.VSSM, dims=96, depths=[3,3,6,2], ssm_d_state=1, ssm_dt_rank="auto", ssm_ratio=1.0, ssm_conv=5, forward_type="xv1a_act", mlp_ratio=4.0, downsample_version="v3", patchembed_version="v2", norm_layer="ln2d") # GFlops:  4.881525503999999 Params:  27284104 1419
