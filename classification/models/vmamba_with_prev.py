...
# you do not have to install mamba_ssm if you are not to use SelectiveScanMamba
# you do not have to install `kernels/selective_scan` or `mamba_ssm` if you are about to use VMamba with mamba2
